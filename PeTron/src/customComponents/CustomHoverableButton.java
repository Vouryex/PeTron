...
public class CustomHoverableButton extends GameButton {
	
	private BufferedImage buttonDefaultImage;
	private BufferedImage buttonHoveredImage;

	public CustomHoverableButton(String buttonImageSource, String buttonHoveredImageSource, int leftBound, int upBound, int width, int height) {
