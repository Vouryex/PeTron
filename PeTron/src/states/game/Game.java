...
public class Game extends GameState {
	...
	public void init(GameStateEngine gameStateEngine) {
		...
		motorBiker1 = Player1.getInstance();
		motorBiker2 = Player2.getInstance();
	...
	private void loadImages() throws IOException {
		loadCountdownImages();
		emptyCursor = ImageIO.read((getClass().getResourceAsStream("/res/images/game/Blank Cursor.png")));
	}
	
	private void loadCountdownImages() throws IOException {
		one = ImageIO.read((getClass().getResourceAsStream("/res/images/game/1.png")));
		two = ImageIO.read((getClass().getResourceAsStream("/res/images/game/2.png")));
		three = ImageIO.read((getClass().getResourceAsStream("/res/images/game/3.png")));
	}
