...
public class StatusBar implements Paintable {
	...
	public StatusBar(Game game) {
		...
		initDimensions(game);
		try {
			bar = ImageIO.read((getClass().getResourceAsStream("/res/images/game/StatusBarFinalFinal.png")));
			shieldStatusCount = ImageIO.read((getClass().getResourceAsStream("/res/images/game/ShieldStatusSheet.png")));
			sideBladeStatusCount = ImageIO.read((getClass().getResourceAsStream("/res/images/game/SideBladeStatusSheet.png")));
			reverseStatusCount = ImageIO.read((getClass().getResourceAsStream("/res/images/game/ReverseStatusSheet.png")));
			player1NumberSheet = ImageIO.read((getClass().getResourceAsStream("/res/images/game/Score Numbers1.png")));
			player2NumberSheet = ImageIO.read((getClass().getResourceAsStream("/res/images/game/Score Numbers2.png")));
		} catch(IOException e) {
			e.printStackTrace();
		}
