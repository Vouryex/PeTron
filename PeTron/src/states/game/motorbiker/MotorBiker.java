...
import states.game.gameinterfaces.Movable;
	...
	public MotorBiker(int xPos, int yPos, int direction, Color color, 
		...
		try {
			...
			if(color == Color.YELLOW) {
				leftImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker_left.png")));
				rightImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker_right.png")));
				upImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker_up.png")));
				downImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker_down.png")));
			} else if(color == Color.MAGENTA) {
				leftImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker2_left.png")));
				rightImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker2_right.png")));
				upImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker2_up.png")));
				downImage = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/MotorBiker2_down.png")));
			}
			/***************/
			
			/**Explosions**/
			explodeHorizontal = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/motorbiker explode1.png")));
			explodeHorizontal2 = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/motorbiker explode1.png")));
			explodeVertical = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/motorbiker explode2.png")));
			explodeVertical2 = ImageIO.read((getClass().getResourceAsStream("/res/images/motorbiker/motorbiker explode2.png")));
			/**************/
		} catch(IOException e) {
			e.printStackTrace();
		}
