...
public class Credits extends GameState {
	...
	public void init(GameStateEngine gameStateEngine) {
		...
		/**Load images**/
		try {
			insideCredits = ImageIO.read((getClass().getResourceAsStream("/images/states/InsideCredits.png")));
			back = ImageIO.read((getClass().getResourceAsStream("/images/states/Back.png")));
			back2 = ImageIO.read((getClass().getResourceAsStream("/images/states/Back2.png")));
		} catch(IOException e) {
			e.printStackTrace();
		}
		/***************/
